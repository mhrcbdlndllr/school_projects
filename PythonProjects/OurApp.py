...
# read question.txt for questions : Tisha Enopia
questions = []
...
window.geometry("2340x1080")
button = Button(window, text="Start", command=askQuestion)
button.place(x=300, y=300, width=300, height=250)
window.mainloop()